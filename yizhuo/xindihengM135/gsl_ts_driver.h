...
#if defined(DROI_PRO_PWU6_DNT_P09)
#define GSL_TIMER			//定时器宏
#endif



#if defined(DROI_PRO_PWU5_XDH_M135M)
	#define TPD_PROXIMITY		//距离传感器宏
#else
	#define GSL_GESTURE    //贴脸灭屏，需要关闭智能手势
#endif

//#define GSL_GPIO_IDT_TP	//GPIO兼容	
//#define GSL_DRV_WIRE_IDT_TP	//驱动线兼容

#if defined(DROI_PRO_PWU6_DNT_P09)||defined(DROI_PRO_PWU5_XDH_M135M)
...
#if defined (DROI_PRO_PU6A_RF_R9002) || defined(DROI_PRO_PU6A_DNT_01)
...
#if defined(DROI_PRO_PWU5_LG)
#include "gsl_ts_fw_pwu5_lg.h"
#elif defined(DROI_PRO_PWU6_DNT)
    #include "gsl_ts_fw_pwu6_dnt.h"
#elif defined(DROI_PRO_PWU5_DNT)
    #include "gsl_ts_fw_pwu5_dnt.h"
#elif defined(DROI_PRO_PWU5_XDH)
    #include "gsl_ts_fw_pwu5_xdh.h"
#else
/* Fixme mem Alig */
struct fw_data
{
